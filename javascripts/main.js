...
$('#logout-container').on("click", "#logoutButton", function(){
	FbAPI.logoutUser();
	uid = "";
	$('#incomplete-tasks').html(""); //clears this div
	$('completed-tasks').html(""); //clears this one, too
	$('#inputEmail').val(""); // before showing to login section, deletes email	
	$('#inputPassword').val(""); // before showing to login section, deletes password
	$('#inputUsername').val(""); // before showing to login section, deletes username
	$('#login-container').removeClass("hide"); //shows the login section
	$('#todo-container').addClass("hide"); //hides the other sections
});
